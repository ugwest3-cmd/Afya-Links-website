        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center mb-6 group">
              <div className="relative w-[200px] h-12 flex items-center justify-start transition-transform group-hover:scale-105">
                <Image 
                  src="/assets/logo.png" 
                  alt="Afya Links Logo" 
                  width={200} 
                  height={48} 
                  className="w-full h-full object-contain drop-shadow-sm brightness-0" 
                />
              </div>
            </Link>
